...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1988
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1988
...
*** Rename 1988 Variables
rename V15130 age1_1988, replace
rename V15132 age2_1988, replace
rename V15761 childcare1_1988, replace
rename V14802 family_ID1_1988, replace
rename V14935 tax_inc1_1988, replace
rename V14949 gssi2_1988, replace
rename V14970 gssi3_1988, replace
rename V15136 mstat1_1988, replace
rename V16187 mstat2_1988, replace
rename V14939 num_dep1_1988, replace
rename V15133 num_dep2_1988, replace
rename V14954 pension_inc2_1988, replace
rename V14952 pension_inc3_1988, replace
rename V14975 pension_inc4_1988, replace
rename V14973 pension_inc5_1988, replace
rename V14803 state1_1988, replace
rename V14985 transfers1_1988, replace
rename V14956 unemp_inc2_1988, replace
rename V14976 unemp_inc3_1988, replace
rename V16145 wages1_1988, replace
rename V14920 wages2_1988, replace

*** Clean 1988 Variables
replace age1_1988 = . if age1_1988 == 99
replace age2_1988 = . if age2_1988 == 99
replace mstat2_1988 = . if mstat2_1988 == 9
replace mstat1_1988 = . if mstat1_1988 == 9
replace state1_1988 = . if state1_1988 == 99
replace childcare1_1988 = 0 if childcare1_1988 == 99999
...
replace state = 1 if state1_1988 == 1   // AL
replace state = 2 if state1_1988 == 50   // AK
replace state = 3 if state1_1988 == 2   // AZ
replace state = 4 if state1_1988 == 3   // AR
replace state = 5 if state1_1988 == 4   // CA
replace state = 6 if state1_1988 == 5   // CO
replace state = 7 if state1_1988 == 6   // CT
replace state = 8 if state1_1988 == 7   // DE
replace state = 9 if state1_1988 == 8   // DC
replace state = 10 if state1_1988 == 9   // FL
replace state = 11 if state1_1988 == 10   // GA
replace state = 12 if state1_1988 == 51   // HI
replace state = 13 if state1_1988 == 11   // ID
replace state = 14 if state1_1988 == 12   // IL
replace state = 15 if state1_1988 == 13   // IN
replace state = 16 if state1_1988 == 14   // IA
replace state = 17 if state1_1988 == 15   // KS
replace state = 18 if state1_1988 == 16   // KY
replace state = 19 if state1_1988 == 17   // LA
replace state = 20 if state1_1988 == 18   // ME
replace state = 21 if state1_1988 == 19   // MD
replace state = 22 if state1_1988 == 20   // MA
replace state = 23 if state1_1988 == 21   // MI
replace state = 24 if state1_1988 == 22   // MN
replace state = 25 if state1_1988 == 23   // MS
replace state = 26 if state1_1988 == 24   // MO
replace state = 27 if state1_1988 == 25   // MT
replace state = 28 if state1_1988 == 26   // NE
replace state = 29 if state1_1988 == 27   // NV
replace state = 30 if state1_1988 == 28   // NH
replace state = 31 if state1_1988 == 29   // NJ
replace state = 32 if state1_1988 == 30   // NM
replace state = 33 if state1_1988 == 31   // NY
replace state = 34 if state1_1988 == 32   // NC
replace state = 35 if state1_1988 == 33   // ND
replace state = 36 if state1_1988 == 34   // OH
replace state = 37 if state1_1988 == 35   // OK
replace state = 38 if state1_1988 == 36   // OR
replace state = 39 if state1_1988 == 37   // PA
replace state = 40 if state1_1988 == 38   // RI
replace state = 41 if state1_1988 == 39   // SC
replace state = 42 if state1_1988 == 40   // SD
replace state = 43 if state1_1988 == 41   // TN
replace state = 44 if state1_1988 == 42   // TX
replace state = 45 if state1_1988 == 43   // UT
replace state = 46 if state1_1988 == 44   // VT
replace state = 47 if state1_1988 == 45   // VA
replace state = 48 if state1_1988 == 46   // WA
replace state = 49 if state1_1988 == 47   // WV
replace state = 50 if state1_1988 == 48   // WI
replace state = 51 if state1_1988 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1988 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1988 > 65 & age1_1988 ~= .
replace agex = agex + 1 if age2_1988 > 65 & age2_1988 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1988
...
gen swages = wages2_1988
* Business labor income not added

*** Set Pension Income
* Pension income for 1968-1969 surveys not calculated because only bracketed data available
gen pensions = 0
replace pensions = pension_inc2_1988
replace pensions = pensions + pension_inc3_1988
* Calculate spouse's pension income (1985 + )
gen spouse_pensions = 0
replace spouse_pensions = spouse_pensions + pension_inc4_1988
replace spouse_pensions = spouse_pensions + pension_inc5_1988
...
gen otherprop = 0
replace otherprop = tax_inc1_1988 - pensions - pwages - swages if tax_inc1_1988 > pensions + pwages + swages
...
gen gssi = 0
replace gssi = gssi2_1988
replace gssi = gssi + gssi3_1988
...
gen childcare = 0
replace childcare = childcare1_1988
