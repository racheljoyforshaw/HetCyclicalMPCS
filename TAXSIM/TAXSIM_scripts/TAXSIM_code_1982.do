...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1982
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1982
...
*** Rename 1982 Variables
rename V8352 age1_1982, replace
rename V8354 age2_1982, replace
rename V8202 family_ID1_1982, replace
rename V8283 tax_inc1_1982, replace
rename V8292 gssi1_1982, replace
rename V8603 mstat1_1982, replace
rename V8711 mstat2_1982, replace
rename V8285 num_dep1_1982, replace
rename V8355 num_dep2_1982, replace
rename V8615 num_dep3_1982, replace
rename V8293 pension_inc1_1982, replace
rename V8219 prop_tax1_1982, replace
rename V8221 rent1_1982, replace
rename V8203 state1_1982, replace
rename V8301 transfers1_1982, replace
rename V8294 unemp_inc2_1982, replace
rename V8690 wages1_1982, replace
rename V8273 wages2_1982, replace

*** Clean 1982 Variables
replace age1_1982 = . if age1_1982 == 99
replace age2_1982 = . if age2_1982 == 99
replace num_dep3_1982 = 0 if num_dep3_1982 == 9
replace mstat2_1982 = . if mstat2_1982 == 9
replace mstat1_1982 = . if mstat1_1982 == 9
replace state1_1982 = . if state1_1982 == 99
...
replace state = 1 if state1_1982 == 1   // AL
replace state = 2 if state1_1982 == 50   // AK
replace state = 3 if state1_1982 == 2   // AZ
replace state = 4 if state1_1982 == 3   // AR
replace state = 5 if state1_1982 == 4   // CA
replace state = 6 if state1_1982 == 5   // CO
replace state = 7 if state1_1982 == 6   // CT
replace state = 8 if state1_1982 == 7   // DE
replace state = 9 if state1_1982 == 8   // DC
replace state = 10 if state1_1982 == 9   // FL
replace state = 11 if state1_1982 == 10   // GA
replace state = 12 if state1_1982 == 51   // HI
replace state = 13 if state1_1982 == 11   // ID
replace state = 14 if state1_1982 == 12   // IL
replace state = 15 if state1_1982 == 13   // IN
replace state = 16 if state1_1982 == 14   // IA
replace state = 17 if state1_1982 == 15   // KS
replace state = 18 if state1_1982 == 16   // KY
replace state = 19 if state1_1982 == 17   // LA
replace state = 20 if state1_1982 == 18   // ME
replace state = 21 if state1_1982 == 19   // MD
replace state = 22 if state1_1982 == 20   // MA
replace state = 23 if state1_1982 == 21   // MI
replace state = 24 if state1_1982 == 22   // MN
replace state = 25 if state1_1982 == 23   // MS
replace state = 26 if state1_1982 == 24   // MO
replace state = 27 if state1_1982 == 25   // MT
replace state = 28 if state1_1982 == 26   // NE
replace state = 29 if state1_1982 == 27   // NV
replace state = 30 if state1_1982 == 28   // NH
replace state = 31 if state1_1982 == 29   // NJ
replace state = 32 if state1_1982 == 30   // NM
replace state = 33 if state1_1982 == 31   // NY
replace state = 34 if state1_1982 == 32   // NC
replace state = 35 if state1_1982 == 33   // ND
replace state = 36 if state1_1982 == 34   // OH
replace state = 37 if state1_1982 == 35   // OK
replace state = 38 if state1_1982 == 36   // OR
replace state = 39 if state1_1982 == 37   // PA
replace state = 40 if state1_1982 == 38   // RI
replace state = 41 if state1_1982 == 39   // SC
replace state = 42 if state1_1982 == 40   // SD
replace state = 43 if state1_1982 == 41   // TN
replace state = 44 if state1_1982 == 42   // TX
replace state = 45 if state1_1982 == 43   // UT
replace state = 46 if state1_1982 == 44   // VT
replace state = 47 if state1_1982 == 45   // VA
replace state = 48 if state1_1982 == 46   // WA
replace state = 49 if state1_1982 == 47   // WV
replace state = 50 if state1_1982 == 48   // WI
replace state = 51 if state1_1982 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1982 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1982 > 65 & age1_1982 ~= .
replace agex = agex + 1 if age2_1982 > 65 & age2_1982 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1982
...
gen otherprop = 0
replace otherprop = tax_inc1_1982 - pensions - pwages - swages if tax_inc1_1982 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1982 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1982

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1982
