...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1970
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1970
...
*** Rename 1970 Variables
rename V1239 age1_1970, replace
rename V1241 age2_1970, replace
rename V1164 childcare1_1970, replace
rename V1102 family_ID1_1970, replace
rename V1205 tax_inc1_1970, replace
rename V1212 gssi1_1970, replace
rename V1365 mstat2_1970, replace
rename V1207 num_dep1_1970, replace
rename V1242 num_dep2_1970, replace
rename V1401 num_dep3_1970, replace
rename V1213 pension_inc1_1970, replace
rename V1509 prop_tax1_1970, replace
rename V1128 rent1_1970, replace
rename V1103 state1_1970, replace
rename V1220 transfers1_1970, replace
rename V1214 unemp_inc1_1970, replace
rename V1196 wages1_1970, replace
rename V1198 wages2_1970, replace

*** Clean 1970 Variables
replace age1_1970 = . if age1_1970 == 99
replace age2_1970 = . if age2_1970 == 99
replace num_dep3_1970 = 0 if num_dep3_1970 == 9
replace state1_1970 = . if state1_1970 == 99
...
replace state = 1 if state1_1970 == 1   // AL
replace state = 2 if state1_1970 == 50   // AK
replace state = 3 if state1_1970 == 2   // AZ
replace state = 4 if state1_1970 == 3   // AR
replace state = 5 if state1_1970 == 4   // CA
replace state = 6 if state1_1970 == 5   // CO
replace state = 7 if state1_1970 == 6   // CT
replace state = 8 if state1_1970 == 7   // DE
replace state = 9 if state1_1970 == 8   // DC
replace state = 10 if state1_1970 == 9   // FL
replace state = 11 if state1_1970 == 10   // GA
replace state = 12 if state1_1970 == 51   // HI
replace state = 13 if state1_1970 == 11   // ID
replace state = 14 if state1_1970 == 12   // IL
replace state = 15 if state1_1970 == 13   // IN
replace state = 16 if state1_1970 == 14   // IA
replace state = 17 if state1_1970 == 15   // KS
replace state = 18 if state1_1970 == 16   // KY
replace state = 19 if state1_1970 == 17   // LA
replace state = 20 if state1_1970 == 18   // ME
replace state = 21 if state1_1970 == 19   // MD
replace state = 22 if state1_1970 == 20   // MA
replace state = 23 if state1_1970 == 21   // MI
replace state = 24 if state1_1970 == 22   // MN
replace state = 25 if state1_1970 == 23   // MS
replace state = 26 if state1_1970 == 24   // MO
replace state = 27 if state1_1970 == 25   // MT
replace state = 28 if state1_1970 == 26   // NE
replace state = 29 if state1_1970 == 27   // NV
replace state = 30 if state1_1970 == 28   // NH
replace state = 31 if state1_1970 == 29   // NJ
replace state = 32 if state1_1970 == 30   // NM
replace state = 33 if state1_1970 == 31   // NY
replace state = 34 if state1_1970 == 32   // NC
replace state = 35 if state1_1970 == 33   // ND
replace state = 36 if state1_1970 == 34   // OH
replace state = 37 if state1_1970 == 35   // OK
replace state = 38 if state1_1970 == 36   // OR
replace state = 39 if state1_1970 == 37   // PA
replace state = 40 if state1_1970 == 38   // RI
replace state = 41 if state1_1970 == 39   // SC
replace state = 42 if state1_1970 == 40   // SD
replace state = 43 if state1_1970 == 41   // TN
replace state = 44 if state1_1970 == 42   // TX
replace state = 45 if state1_1970 == 43   // UT
replace state = 46 if state1_1970 == 44   // VT
replace state = 47 if state1_1970 == 45   // VA
replace state = 48 if state1_1970 == 46   // WA
replace state = 49 if state1_1970 == 47   // WV
replace state = 50 if state1_1970 == 48   // WI
replace state = 51 if state1_1970 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1970 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1970 > 65 & age1_1970 ~= .
replace agex = agex + 1 if age2_1970 > 65 & age2_1970 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1970
...
gen otherprop = 0
replace otherprop = tax_inc1_1970 - pensions - pwages - swages if tax_inc1_1970 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1970 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1970

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1970
...
gen childcare = 0
replace childcare = childcare1_1970
