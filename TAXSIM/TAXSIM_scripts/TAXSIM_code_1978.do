...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1978
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1978
...
*** Rename 1978 Variables
rename V5850 age1_1978, replace
rename V5852 age2_1978, replace
rename V5702 family_ID1_1978, replace
rename V5796 tax_inc1_1978, replace
rename V5806 gssi1_1978, replace
rename V6034 mstat1_1978, replace
rename V6197 mstat2_1978, replace
rename V5799 num_dep1_1978, replace
rename V5853 num_dep2_1978, replace
rename V6100 num_dep3_1978, replace
rename V5807 pension_inc1_1978, replace
rename V5723 rent1_1978, replace
rename V5703 state1_1978, replace
rename V5815 transfers1_1978, replace
rename V5808 unemp_inc2_1978, replace
rename V6174 wages1_1978, replace
rename V5788 wages2_1978, replace

*** Clean 1978 Variables
replace age1_1978 = . if age1_1978 == 99
replace age2_1978 = . if age2_1978 == 99
replace num_dep3_1978 = 0 if num_dep3_1978 == 9
replace state1_1978 = . if state1_1978 == 99
...
replace state = 1 if state1_1978 == 1   // AL
replace state = 2 if state1_1978 == 50   // AK
replace state = 3 if state1_1978 == 2   // AZ
replace state = 4 if state1_1978 == 3   // AR
replace state = 5 if state1_1978 == 4   // CA
replace state = 6 if state1_1978 == 5   // CO
replace state = 7 if state1_1978 == 6   // CT
replace state = 8 if state1_1978 == 7   // DE
replace state = 9 if state1_1978 == 8   // DC
replace state = 10 if state1_1978 == 9   // FL
replace state = 11 if state1_1978 == 10   // GA
replace state = 12 if state1_1978 == 51   // HI
replace state = 13 if state1_1978 == 11   // ID
replace state = 14 if state1_1978 == 12   // IL
replace state = 15 if state1_1978 == 13   // IN
replace state = 16 if state1_1978 == 14   // IA
replace state = 17 if state1_1978 == 15   // KS
replace state = 18 if state1_1978 == 16   // KY
replace state = 19 if state1_1978 == 17   // LA
replace state = 20 if state1_1978 == 18   // ME
replace state = 21 if state1_1978 == 19   // MD
replace state = 22 if state1_1978 == 20   // MA
replace state = 23 if state1_1978 == 21   // MI
replace state = 24 if state1_1978 == 22   // MN
replace state = 25 if state1_1978 == 23   // MS
replace state = 26 if state1_1978 == 24   // MO
replace state = 27 if state1_1978 == 25   // MT
replace state = 28 if state1_1978 == 26   // NE
replace state = 29 if state1_1978 == 27   // NV
replace state = 30 if state1_1978 == 28   // NH
replace state = 31 if state1_1978 == 29   // NJ
replace state = 32 if state1_1978 == 30   // NM
replace state = 33 if state1_1978 == 31   // NY
replace state = 34 if state1_1978 == 32   // NC
replace state = 35 if state1_1978 == 33   // ND
replace state = 36 if state1_1978 == 34   // OH
replace state = 37 if state1_1978 == 35   // OK
replace state = 38 if state1_1978 == 36   // OR
replace state = 39 if state1_1978 == 37   // PA
replace state = 40 if state1_1978 == 38   // RI
replace state = 41 if state1_1978 == 39   // SC
replace state = 42 if state1_1978 == 40   // SD
replace state = 43 if state1_1978 == 41   // TN
replace state = 44 if state1_1978 == 42   // TX
replace state = 45 if state1_1978 == 43   // UT
replace state = 46 if state1_1978 == 44   // VT
replace state = 47 if state1_1978 == 45   // VA
replace state = 48 if state1_1978 == 46   // WA
replace state = 49 if state1_1978 == 47   // WV
replace state = 50 if state1_1978 == 48   // WI
replace state = 51 if state1_1978 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1978 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1978 > 65 & age1_1978 ~= .
replace agex = agex + 1 if age2_1978 > 65 & age2_1978 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1978
...
gen otherprop = 0
replace otherprop = tax_inc1_1978 - pensions - pwages - swages if tax_inc1_1978 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1978 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1978
