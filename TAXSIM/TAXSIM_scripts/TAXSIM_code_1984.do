...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1984
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1984
...
*** Rename 1984 Variables
rename V10419 age1_1984, replace
rename V10421 age2_1984, replace
rename V10002 family_ID1_1984, replace
rename V10277 tax_inc1_1984, replace
rename V10288 gssi1_1984, replace
rename V10426 mstat1_1984, replace
rename V11065 mstat2_1984, replace
rename V10279 num_dep1_1984, replace
rename V10422 num_dep2_1984, replace
rename V10897 num_dep3_1984, replace
rename V10293 pension_inc2_1984, replace
rename V10291 pension_inc3_1984, replace
rename V10024 prop_tax1_1984, replace
rename V10026 rent1_1984, replace
rename V10003 state1_1984, replace
rename V10305 transfers1_1984, replace
rename V10295 unemp_inc2_1984, replace
rename V11023 wages1_1984, replace
rename V10263 wages2_1984, replace

*** Clean 1984 Variables
replace age1_1984 = . if age1_1984 == 99
replace age2_1984 = . if age2_1984 == 99
replace num_dep3_1984 = 0 if num_dep3_1984 == 9
replace mstat2_1984 = . if mstat2_1984 == 9
replace mstat1_1984 = . if mstat1_1984 == 9
replace state1_1984 = . if state1_1984 == 99
...
replace state = 1 if state1_1984 == 1   // AL
replace state = 2 if state1_1984 == 50   // AK
replace state = 3 if state1_1984 == 2   // AZ
replace state = 4 if state1_1984 == 3   // AR
replace state = 5 if state1_1984 == 4   // CA
replace state = 6 if state1_1984 == 5   // CO
replace state = 7 if state1_1984 == 6   // CT
replace state = 8 if state1_1984 == 7   // DE
replace state = 9 if state1_1984 == 8   // DC
replace state = 10 if state1_1984 == 9   // FL
replace state = 11 if state1_1984 == 10   // GA
replace state = 12 if state1_1984 == 51   // HI
replace state = 13 if state1_1984 == 11   // ID
replace state = 14 if state1_1984 == 12   // IL
replace state = 15 if state1_1984 == 13   // IN
replace state = 16 if state1_1984 == 14   // IA
replace state = 17 if state1_1984 == 15   // KS
replace state = 18 if state1_1984 == 16   // KY
replace state = 19 if state1_1984 == 17   // LA
replace state = 20 if state1_1984 == 18   // ME
replace state = 21 if state1_1984 == 19   // MD
replace state = 22 if state1_1984 == 20   // MA
replace state = 23 if state1_1984 == 21   // MI
replace state = 24 if state1_1984 == 22   // MN
replace state = 25 if state1_1984 == 23   // MS
replace state = 26 if state1_1984 == 24   // MO
replace state = 27 if state1_1984 == 25   // MT
replace state = 28 if state1_1984 == 26   // NE
replace state = 29 if state1_1984 == 27   // NV
replace state = 30 if state1_1984 == 28   // NH
replace state = 31 if state1_1984 == 29   // NJ
replace state = 32 if state1_1984 == 30   // NM
replace state = 33 if state1_1984 == 31   // NY
replace state = 34 if state1_1984 == 32   // NC
replace state = 35 if state1_1984 == 33   // ND
replace state = 36 if state1_1984 == 34   // OH
replace state = 37 if state1_1984 == 35   // OK
replace state = 38 if state1_1984 == 36   // OR
replace state = 39 if state1_1984 == 37   // PA
replace state = 40 if state1_1984 == 38   // RI
replace state = 41 if state1_1984 == 39   // SC
replace state = 42 if state1_1984 == 40   // SD
replace state = 43 if state1_1984 == 41   // TN
replace state = 44 if state1_1984 == 42   // TX
replace state = 45 if state1_1984 == 43   // UT
replace state = 46 if state1_1984 == 44   // VT
replace state = 47 if state1_1984 == 45   // VA
replace state = 48 if state1_1984 == 46   // WA
replace state = 49 if state1_1984 == 47   // WV
replace state = 50 if state1_1984 == 48   // WI
replace state = 51 if state1_1984 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1984 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1984 > 65 & age1_1984 ~= .
replace agex = agex + 1 if age2_1984 > 65 & age2_1984 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1984
...
gen otherprop = 0
replace otherprop = tax_inc1_1984 - pensions - pwages - swages if tax_inc1_1984 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1984 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1984

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1984
