...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1980
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1980
...
*** Rename 1980 Variables
rename V7067 age1_1980, replace
rename V7069 age2_1980, replace
rename V6902 family_ID1_1980, replace
rename V6998 tax_inc1_1980, replace
rename V7007 gssi1_1980, replace
rename V7261 mstat1_1980, replace
rename V7435 mstat2_1980, replace
rename V7000 num_dep1_1980, replace
rename V7070 num_dep2_1980, replace
rename V7296 num_dep3_1980, replace
rename V7008 pension_inc1_1980, replace
rename V6923 prop_tax1_1980, replace
rename V6925 rent1_1980, replace
rename V6903 state1_1980, replace
rename V7016 transfers1_1980, replace
rename V7009 unemp_inc2_1980, replace
rename V7413 wages1_1980, replace
rename V6988 wages2_1980, replace

*** Clean 1980 Variables
replace age1_1980 = . if age1_1980 == 99
replace age2_1980 = . if age2_1980 == 99
replace num_dep3_1980 = 0 if num_dep3_1980 == 9
replace state1_1980 = . if state1_1980 == 99
replace prop_tax1_1980 = . if prop_tax1_1980 == 9999
...
replace state = 1 if state1_1980 == 1   // AL
replace state = 2 if state1_1980 == 50   // AK
replace state = 3 if state1_1980 == 2   // AZ
replace state = 4 if state1_1980 == 3   // AR
replace state = 5 if state1_1980 == 4   // CA
replace state = 6 if state1_1980 == 5   // CO
replace state = 7 if state1_1980 == 6   // CT
replace state = 8 if state1_1980 == 7   // DE
replace state = 9 if state1_1980 == 8   // DC
replace state = 10 if state1_1980 == 9   // FL
replace state = 11 if state1_1980 == 10   // GA
replace state = 12 if state1_1980 == 51   // HI
replace state = 13 if state1_1980 == 11   // ID
replace state = 14 if state1_1980 == 12   // IL
replace state = 15 if state1_1980 == 13   // IN
replace state = 16 if state1_1980 == 14   // IA
replace state = 17 if state1_1980 == 15   // KS
replace state = 18 if state1_1980 == 16   // KY
replace state = 19 if state1_1980 == 17   // LA
replace state = 20 if state1_1980 == 18   // ME
replace state = 21 if state1_1980 == 19   // MD
replace state = 22 if state1_1980 == 20   // MA
replace state = 23 if state1_1980 == 21   // MI
replace state = 24 if state1_1980 == 22   // MN
replace state = 25 if state1_1980 == 23   // MS
replace state = 26 if state1_1980 == 24   // MO
replace state = 27 if state1_1980 == 25   // MT
replace state = 28 if state1_1980 == 26   // NE
replace state = 29 if state1_1980 == 27   // NV
replace state = 30 if state1_1980 == 28   // NH
replace state = 31 if state1_1980 == 29   // NJ
replace state = 32 if state1_1980 == 30   // NM
replace state = 33 if state1_1980 == 31   // NY
replace state = 34 if state1_1980 == 32   // NC
replace state = 35 if state1_1980 == 33   // ND
replace state = 36 if state1_1980 == 34   // OH
replace state = 37 if state1_1980 == 35   // OK
replace state = 38 if state1_1980 == 36   // OR
replace state = 39 if state1_1980 == 37   // PA
replace state = 40 if state1_1980 == 38   // RI
replace state = 41 if state1_1980 == 39   // SC
replace state = 42 if state1_1980 == 40   // SD
replace state = 43 if state1_1980 == 41   // TN
replace state = 44 if state1_1980 == 42   // TX
replace state = 45 if state1_1980 == 43   // UT
replace state = 46 if state1_1980 == 44   // VT
replace state = 47 if state1_1980 == 45   // VA
replace state = 48 if state1_1980 == 46   // WA
replace state = 49 if state1_1980 == 47   // WV
replace state = 50 if state1_1980 == 48   // WI
replace state = 51 if state1_1980 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1980 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1980 > 65 & age1_1980 ~= .
replace agex = agex + 1 if age2_1980 > 65 & age2_1980 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1980
...
gen otherprop = 0
replace otherprop = tax_inc1_1980 - pensions - pwages - swages if tax_inc1_1980 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1980 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1980

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1980
