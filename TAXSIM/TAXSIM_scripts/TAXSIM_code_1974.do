...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1974
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1974
...
*** Rename 1974 Variables
rename V3508 age1_1974, replace
rename V3510 age2_1974, replace
rename V3402 family_ID1_1974, replace
rename V3472 tax_inc1_1974, replace
rename V3480 gssi1_1974, replace
rename V3598 mstat2_1974, replace
rename V3475 num_dep1_1974, replace
rename V3511 num_dep2_1974, replace
rename V3633 num_dep3_1974, replace
rename V3481 pension_inc1_1974, replace
rename V3674 prop_tax1_1974, replace
rename V3419 rent1_1974, replace
rename V3403 state1_1974, replace
rename V3488 transfers1_1974, replace
rename V3482 unemp_inc1_1974, replace
rename V3463 wages1_1974, replace
rename V3465 wages2_1974, replace

*** Clean 1974 Variables
replace age1_1974 = . if age1_1974 == 99
replace age2_1974 = . if age2_1974 == 99
replace num_dep3_1974 = 0 if num_dep3_1974 == 9
replace state1_1974 = . if state1_1974 == 99
...
replace state = 1 if state1_1974 == 1   // AL
replace state = 2 if state1_1974 == 50   // AK
replace state = 3 if state1_1974 == 2   // AZ
replace state = 4 if state1_1974 == 3   // AR
replace state = 5 if state1_1974 == 4   // CA
replace state = 6 if state1_1974 == 5   // CO
replace state = 7 if state1_1974 == 6   // CT
replace state = 8 if state1_1974 == 7   // DE
replace state = 9 if state1_1974 == 8   // DC
replace state = 10 if state1_1974 == 9   // FL
replace state = 11 if state1_1974 == 10   // GA
replace state = 12 if state1_1974 == 51   // HI
replace state = 13 if state1_1974 == 11   // ID
replace state = 14 if state1_1974 == 12   // IL
replace state = 15 if state1_1974 == 13   // IN
replace state = 16 if state1_1974 == 14   // IA
replace state = 17 if state1_1974 == 15   // KS
replace state = 18 if state1_1974 == 16   // KY
replace state = 19 if state1_1974 == 17   // LA
replace state = 20 if state1_1974 == 18   // ME
replace state = 21 if state1_1974 == 19   // MD
replace state = 22 if state1_1974 == 20   // MA
replace state = 23 if state1_1974 == 21   // MI
replace state = 24 if state1_1974 == 22   // MN
replace state = 25 if state1_1974 == 23   // MS
replace state = 26 if state1_1974 == 24   // MO
replace state = 27 if state1_1974 == 25   // MT
replace state = 28 if state1_1974 == 26   // NE
replace state = 29 if state1_1974 == 27   // NV
replace state = 30 if state1_1974 == 28   // NH
replace state = 31 if state1_1974 == 29   // NJ
replace state = 32 if state1_1974 == 30   // NM
replace state = 33 if state1_1974 == 31   // NY
replace state = 34 if state1_1974 == 32   // NC
replace state = 35 if state1_1974 == 33   // ND
replace state = 36 if state1_1974 == 34   // OH
replace state = 37 if state1_1974 == 35   // OK
replace state = 38 if state1_1974 == 36   // OR
replace state = 39 if state1_1974 == 37   // PA
replace state = 40 if state1_1974 == 38   // RI
replace state = 41 if state1_1974 == 39   // SC
replace state = 42 if state1_1974 == 40   // SD
replace state = 43 if state1_1974 == 41   // TN
replace state = 44 if state1_1974 == 42   // TX
replace state = 45 if state1_1974 == 43   // UT
replace state = 46 if state1_1974 == 44   // VT
replace state = 47 if state1_1974 == 45   // VA
replace state = 48 if state1_1974 == 46   // WA
replace state = 49 if state1_1974 == 47   // WV
replace state = 50 if state1_1974 == 48   // WI
replace state = 51 if state1_1974 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1974 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1974 > 65 & age1_1974 ~= .
replace agex = agex + 1 if age2_1974 > 65 & age2_1974 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1974
...
gen otherprop = 0
replace otherprop = tax_inc1_1974 - pensions - pwages - swages if tax_inc1_1974 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1974 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1974

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1974
