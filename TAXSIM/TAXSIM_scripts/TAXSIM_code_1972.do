...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1972
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1972
...
*** Rename 1972 Variables
rename V2542 age1_1972, replace
rename V2544 age2_1972, replace
rename V2465 childcare1_1972, replace
rename V2402 family_ID1_1972, replace
rename V2507 tax_inc1_1972, replace
rename V2515 gssi1_1972, replace
rename V2670 mstat2_1972, replace
rename V2510 num_dep1_1972, replace
rename V2545 num_dep2_1972, replace
rename V2710 num_dep3_1972, replace
rename V2516 pension_inc1_1972, replace
rename V2846 prop_tax1_1972, replace
rename V2429 rent1_1972, replace
rename V2403 state1_1972, replace
rename V2523 transfers1_1972, replace
rename V2517 unemp_inc1_1972, replace
rename V2498 wages1_1972, replace
rename V2500 wages2_1972, replace

*** Clean 1972 Variables
replace age1_1972 = . if age1_1972 == 99
replace age2_1972 = . if age2_1972 == 99
replace num_dep3_1972 = 0 if num_dep3_1972 == 9
replace state1_1972 = . if state1_1972 == 99
...
replace state = 1 if state1_1972 == 1   // AL
replace state = 2 if state1_1972 == 50   // AK
replace state = 3 if state1_1972 == 2   // AZ
replace state = 4 if state1_1972 == 3   // AR
replace state = 5 if state1_1972 == 4   // CA
replace state = 6 if state1_1972 == 5   // CO
replace state = 7 if state1_1972 == 6   // CT
replace state = 8 if state1_1972 == 7   // DE
replace state = 9 if state1_1972 == 8   // DC
replace state = 10 if state1_1972 == 9   // FL
replace state = 11 if state1_1972 == 10   // GA
replace state = 12 if state1_1972 == 51   // HI
replace state = 13 if state1_1972 == 11   // ID
replace state = 14 if state1_1972 == 12   // IL
replace state = 15 if state1_1972 == 13   // IN
replace state = 16 if state1_1972 == 14   // IA
replace state = 17 if state1_1972 == 15   // KS
replace state = 18 if state1_1972 == 16   // KY
replace state = 19 if state1_1972 == 17   // LA
replace state = 20 if state1_1972 == 18   // ME
replace state = 21 if state1_1972 == 19   // MD
replace state = 22 if state1_1972 == 20   // MA
replace state = 23 if state1_1972 == 21   // MI
replace state = 24 if state1_1972 == 22   // MN
replace state = 25 if state1_1972 == 23   // MS
replace state = 26 if state1_1972 == 24   // MO
replace state = 27 if state1_1972 == 25   // MT
replace state = 28 if state1_1972 == 26   // NE
replace state = 29 if state1_1972 == 27   // NV
replace state = 30 if state1_1972 == 28   // NH
replace state = 31 if state1_1972 == 29   // NJ
replace state = 32 if state1_1972 == 30   // NM
replace state = 33 if state1_1972 == 31   // NY
replace state = 34 if state1_1972 == 32   // NC
replace state = 35 if state1_1972 == 33   // ND
replace state = 36 if state1_1972 == 34   // OH
replace state = 37 if state1_1972 == 35   // OK
replace state = 38 if state1_1972 == 36   // OR
replace state = 39 if state1_1972 == 37   // PA
replace state = 40 if state1_1972 == 38   // RI
replace state = 41 if state1_1972 == 39   // SC
replace state = 42 if state1_1972 == 40   // SD
replace state = 43 if state1_1972 == 41   // TN
replace state = 44 if state1_1972 == 42   // TX
replace state = 45 if state1_1972 == 43   // UT
replace state = 46 if state1_1972 == 44   // VT
replace state = 47 if state1_1972 == 45   // VA
replace state = 48 if state1_1972 == 46   // WA
replace state = 49 if state1_1972 == 47   // WV
replace state = 50 if state1_1972 == 48   // WI
replace state = 51 if state1_1972 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1972 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1972 > 65 & age1_1972 ~= .
replace agex = agex + 1 if age2_1972 > 65 & age2_1972 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1972
...
gen otherprop = 0
replace otherprop = tax_inc1_1972 - pensions - pwages - swages if tax_inc1_1972 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1972 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1972

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1972
...
gen childcare = 0
replace childcare = childcare1_1972
