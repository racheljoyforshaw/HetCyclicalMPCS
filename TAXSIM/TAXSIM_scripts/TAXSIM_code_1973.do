...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1973
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1973
...
*** Rename 1973 Variables
rename V3095 age1_1973, replace
rename V3097 age2_1973, replace
rename V3002 family_ID1_1973, replace
rename V3060 tax_inc1_1973, replace
rename V3068 gssi1_1973, replace
rename V3181 mstat2_1973, replace
rename V3063 num_dep1_1973, replace
rename V3098 num_dep2_1973, replace
rename V3214 num_dep3_1973, replace
rename V3069 pension_inc1_1973, replace
rename V3254 prop_tax1_1973, replace
rename V3023 rent1_1973, replace
rename V3003 state1_1973, replace
rename V3076 transfers1_1973, replace
rename V3070 unemp_inc1_1973, replace
rename V3051 wages1_1973, replace
rename V3053 wages2_1973, replace

*** Clean 1973 Variables
replace age1_1973 = . if age1_1973 == 99
replace age2_1973 = . if age2_1973 == 99
replace num_dep3_1973 = 0 if num_dep3_1973 == 9
replace state1_1973 = . if state1_1973 == 99
...
replace state = 1 if state1_1973 == 1   // AL
replace state = 2 if state1_1973 == 50   // AK
replace state = 3 if state1_1973 == 2   // AZ
replace state = 4 if state1_1973 == 3   // AR
replace state = 5 if state1_1973 == 4   // CA
replace state = 6 if state1_1973 == 5   // CO
replace state = 7 if state1_1973 == 6   // CT
replace state = 8 if state1_1973 == 7   // DE
replace state = 9 if state1_1973 == 8   // DC
replace state = 10 if state1_1973 == 9   // FL
replace state = 11 if state1_1973 == 10   // GA
replace state = 12 if state1_1973 == 51   // HI
replace state = 13 if state1_1973 == 11   // ID
replace state = 14 if state1_1973 == 12   // IL
replace state = 15 if state1_1973 == 13   // IN
replace state = 16 if state1_1973 == 14   // IA
replace state = 17 if state1_1973 == 15   // KS
replace state = 18 if state1_1973 == 16   // KY
replace state = 19 if state1_1973 == 17   // LA
replace state = 20 if state1_1973 == 18   // ME
replace state = 21 if state1_1973 == 19   // MD
replace state = 22 if state1_1973 == 20   // MA
replace state = 23 if state1_1973 == 21   // MI
replace state = 24 if state1_1973 == 22   // MN
replace state = 25 if state1_1973 == 23   // MS
replace state = 26 if state1_1973 == 24   // MO
replace state = 27 if state1_1973 == 25   // MT
replace state = 28 if state1_1973 == 26   // NE
replace state = 29 if state1_1973 == 27   // NV
replace state = 30 if state1_1973 == 28   // NH
replace state = 31 if state1_1973 == 29   // NJ
replace state = 32 if state1_1973 == 30   // NM
replace state = 33 if state1_1973 == 31   // NY
replace state = 34 if state1_1973 == 32   // NC
replace state = 35 if state1_1973 == 33   // ND
replace state = 36 if state1_1973 == 34   // OH
replace state = 37 if state1_1973 == 35   // OK
replace state = 38 if state1_1973 == 36   // OR
replace state = 39 if state1_1973 == 37   // PA
replace state = 40 if state1_1973 == 38   // RI
replace state = 41 if state1_1973 == 39   // SC
replace state = 42 if state1_1973 == 40   // SD
replace state = 43 if state1_1973 == 41   // TN
replace state = 44 if state1_1973 == 42   // TX
replace state = 45 if state1_1973 == 43   // UT
replace state = 46 if state1_1973 == 44   // VT
replace state = 47 if state1_1973 == 45   // VA
replace state = 48 if state1_1973 == 46   // WA
replace state = 49 if state1_1973 == 47   // WV
replace state = 50 if state1_1973 == 48   // WI
replace state = 51 if state1_1973 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1973 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1973 > 65 & age1_1973 ~= .
replace agex = agex + 1 if age2_1973 > 65 & age2_1973 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1973
...
gen otherprop = 0
replace otherprop = tax_inc1_1973 - pensions - pwages - swages if tax_inc1_1973 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1973 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1973

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1973
