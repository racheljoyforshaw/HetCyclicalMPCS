...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1992
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1992
...
*** Rename 1992 Variables
rename V20651 age1_1992, replace
rename V20653 age2_1992, replace
rename V21300 childcare1_1992, replace
rename V20302 family_ID1_1992, replace
rename V20451 tax_inc1_1992, replace
rename V20465 gssi2_1992, replace
rename V20486 gssi3_1992, replace
rename V20657 mstat1_1992, replace
rename V21522 mstat2_1992, replace
rename V20654 num_dep2_1992, replace
rename V21320 num_dep3_1992, replace
rename V20470 pension_inc2_1992, replace
rename V20468 pension_inc3_1992, replace
rename V20491 pension_inc4_1992, replace
rename V20489 pension_inc5_1992, replace
rename V20330 prop_tax1_1992, replace
rename V20333 rent1_1992, replace
rename V20303 state1_1992, replace
rename V20501 transfers1_1992, replace
rename V20472 unemp_inc2_1992, replace
rename V20492 unemp_inc3_1992, replace
rename V21484 wages1_1992, replace
rename V20436 wages2_1992, replace

*** Clean 1992 Variables
replace age1_1992 = . if age1_1992 == 99
replace age2_1992 = . if age2_1992 == 99
replace num_dep3_1992 = 0 if num_dep3_1992 == 9
replace mstat2_1992 = . if mstat2_1992 == 9
replace mstat1_1992 = . if mstat1_1992 == 9
replace state1_1992 = . if state1_1992 == 99
replace childcare1_1992 = 0 if childcare1_1992 == 99999
...
replace state = 1 if state1_1992 == 1   // AL
replace state = 2 if state1_1992 == 50   // AK
replace state = 3 if state1_1992 == 2   // AZ
replace state = 4 if state1_1992 == 3   // AR
replace state = 5 if state1_1992 == 4   // CA
replace state = 6 if state1_1992 == 5   // CO
replace state = 7 if state1_1992 == 6   // CT
replace state = 8 if state1_1992 == 7   // DE
replace state = 9 if state1_1992 == 8   // DC
replace state = 10 if state1_1992 == 9   // FL
replace state = 11 if state1_1992 == 10   // GA
replace state = 12 if state1_1992 == 51   // HI
replace state = 13 if state1_1992 == 11   // ID
replace state = 14 if state1_1992 == 12   // IL
replace state = 15 if state1_1992 == 13   // IN
replace state = 16 if state1_1992 == 14   // IA
replace state = 17 if state1_1992 == 15   // KS
replace state = 18 if state1_1992 == 16   // KY
replace state = 19 if state1_1992 == 17   // LA
replace state = 20 if state1_1992 == 18   // ME
replace state = 21 if state1_1992 == 19   // MD
replace state = 22 if state1_1992 == 20   // MA
replace state = 23 if state1_1992 == 21   // MI
replace state = 24 if state1_1992 == 22   // MN
replace state = 25 if state1_1992 == 23   // MS
replace state = 26 if state1_1992 == 24   // MO
replace state = 27 if state1_1992 == 25   // MT
replace state = 28 if state1_1992 == 26   // NE
replace state = 29 if state1_1992 == 27   // NV
replace state = 30 if state1_1992 == 28   // NH
replace state = 31 if state1_1992 == 29   // NJ
replace state = 32 if state1_1992 == 30   // NM
replace state = 33 if state1_1992 == 31   // NY
replace state = 34 if state1_1992 == 32   // NC
replace state = 35 if state1_1992 == 33   // ND
replace state = 36 if state1_1992 == 34   // OH
replace state = 37 if state1_1992 == 35   // OK
replace state = 38 if state1_1992 == 36   // OR
replace state = 39 if state1_1992 == 37   // PA
replace state = 40 if state1_1992 == 38   // RI
replace state = 41 if state1_1992 == 39   // SC
replace state = 42 if state1_1992 == 40   // SD
replace state = 43 if state1_1992 == 41   // TN
replace state = 44 if state1_1992 == 42   // TX
replace state = 45 if state1_1992 == 43   // UT
replace state = 46 if state1_1992 == 44   // VT
replace state = 47 if state1_1992 == 45   // VA
replace state = 48 if state1_1992 == 46   // WA
replace state = 49 if state1_1992 == 47   // WV
replace state = 50 if state1_1992 == 48   // WI
replace state = 51 if state1_1992 == 49   // WY
...
gen swages = wages2_1992
* Business labor income not added

*** Set Pension Income
* Pension income for 1968-1969 surveys not calculated because only bracketed data available
gen pensions = 0
replace pensions = pension_inc2_1992
replace pensions = pensions + pension_inc3_1992
* Calculate spouse's pension income (1985 + )
gen spouse_pensions = 0
replace spouse_pensions = spouse_pensions + pension_inc4_1992
replace spouse_pensions = spouse_pensions + pension_inc5_1992
...
gen otherprop = 0
replace otherprop = tax_inc1_1992 - pensions - pwages - swages if tax_inc1_1992 > pensions + pwages + swages
...
gen gssi = 0
replace gssi = gssi2_1992
replace gssi = gssi + gssi3_1992
...
gen ui = 0
replace ui = unemp_inc2_1992
replace ui = ui + unemp_inc3_1992

*** Set Government Transfer Income
* Measured (when available) as total transfer income less unemployment income
gen transfers = 0
replace transfers = transfers1_1992 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1992

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1992
...
gen childcare = 0
replace childcare = childcare1_1992
