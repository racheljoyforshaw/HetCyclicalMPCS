...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1979
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1979
...
*** Rename 1979 Variables
rename V6462 age1_1979, replace
rename V6464 age2_1979, replace
rename V6387 childcare1_1979, replace
rename V6302 family_ID1_1979, replace
rename V6408 tax_inc1_1979, replace
rename V6417 gssi1_1979, replace
rename V6659 mstat1_1979, replace
rename V6790 mstat2_1979, replace
rename V6410 num_dep1_1979, replace
rename V6465 num_dep2_1979, replace
rename V6693 num_dep3_1979, replace
rename V6418 pension_inc1_1979, replace
rename V6325 prop_tax1_1979, replace
rename V6326 rent1_1979, replace
rename V6303 state1_1979, replace
rename V6426 transfers1_1979, replace
rename V6419 unemp_inc2_1979, replace
rename V6767 wages1_1979, replace
rename V6398 wages2_1979, replace

*** Clean 1979 Variables
replace age1_1979 = . if age1_1979 == 99
replace age2_1979 = . if age2_1979 == 99
replace num_dep3_1979 = 0 if num_dep3_1979 == 9
replace state1_1979 = . if state1_1979 == 99
replace prop_tax1_1979 = . if prop_tax1_1979 == 9999
...
replace state = 1 if state1_1979 == 1   // AL
replace state = 2 if state1_1979 == 50   // AK
replace state = 3 if state1_1979 == 2   // AZ
replace state = 4 if state1_1979 == 3   // AR
replace state = 5 if state1_1979 == 4   // CA
replace state = 6 if state1_1979 == 5   // CO
replace state = 7 if state1_1979 == 6   // CT
replace state = 8 if state1_1979 == 7   // DE
replace state = 9 if state1_1979 == 8   // DC
replace state = 10 if state1_1979 == 9   // FL
replace state = 11 if state1_1979 == 10   // GA
replace state = 12 if state1_1979 == 51   // HI
replace state = 13 if state1_1979 == 11   // ID
replace state = 14 if state1_1979 == 12   // IL
replace state = 15 if state1_1979 == 13   // IN
replace state = 16 if state1_1979 == 14   // IA
replace state = 17 if state1_1979 == 15   // KS
replace state = 18 if state1_1979 == 16   // KY
replace state = 19 if state1_1979 == 17   // LA
replace state = 20 if state1_1979 == 18   // ME
replace state = 21 if state1_1979 == 19   // MD
replace state = 22 if state1_1979 == 20   // MA
replace state = 23 if state1_1979 == 21   // MI
replace state = 24 if state1_1979 == 22   // MN
replace state = 25 if state1_1979 == 23   // MS
replace state = 26 if state1_1979 == 24   // MO
replace state = 27 if state1_1979 == 25   // MT
replace state = 28 if state1_1979 == 26   // NE
replace state = 29 if state1_1979 == 27   // NV
replace state = 30 if state1_1979 == 28   // NH
replace state = 31 if state1_1979 == 29   // NJ
replace state = 32 if state1_1979 == 30   // NM
replace state = 33 if state1_1979 == 31   // NY
replace state = 34 if state1_1979 == 32   // NC
replace state = 35 if state1_1979 == 33   // ND
replace state = 36 if state1_1979 == 34   // OH
replace state = 37 if state1_1979 == 35   // OK
replace state = 38 if state1_1979 == 36   // OR
replace state = 39 if state1_1979 == 37   // PA
replace state = 40 if state1_1979 == 38   // RI
replace state = 41 if state1_1979 == 39   // SC
replace state = 42 if state1_1979 == 40   // SD
replace state = 43 if state1_1979 == 41   // TN
replace state = 44 if state1_1979 == 42   // TX
replace state = 45 if state1_1979 == 43   // UT
replace state = 46 if state1_1979 == 44   // VT
replace state = 47 if state1_1979 == 45   // VA
replace state = 48 if state1_1979 == 46   // WA
replace state = 49 if state1_1979 == 47   // WV
replace state = 50 if state1_1979 == 48   // WI
replace state = 51 if state1_1979 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1979 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1979 > 65 & age1_1979 ~= .
replace agex = agex + 1 if age2_1979 > 65 & age2_1979 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1979
...
gen otherprop = 0
replace otherprop = tax_inc1_1979 - pensions - pwages - swages if tax_inc1_1979 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1979 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1979

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1979
...
gen childcare = 0
replace childcare = childcare1_1979
