...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1987
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1987
...
*** Rename 1987 Variables
rename V14114 age1_1987, replace
rename V14116 age2_1987, replace
rename V13702 family_ID1_1987, replace
rename V13920 tax_inc1_1987, replace
rename V13934 gssi2_1987, replace
rename V13955 gssi3_1987, replace
rename V14120 mstat1_1987, replace
rename V14712 mstat2_1987, replace
rename V13924 num_dep1_1987, replace
rename V14117 num_dep2_1987, replace
rename V14512 num_dep3_1987, replace
rename V13939 pension_inc2_1987, replace
rename V13937 pension_inc3_1987, replace
rename V13960 pension_inc4_1987, replace
rename V13958 pension_inc5_1987, replace
rename V13730 prop_tax1_1987, replace
rename V13732 rent1_1987, replace
rename V13703 state1_1987, replace
rename V13970 transfers1_1987, replace
rename V13941 unemp_inc2_1987, replace
rename V13961 unemp_inc3_1987, replace
rename V14671 wages1_1987, replace
rename V13905 wages2_1987, replace

*** Clean 1987 Variables
replace age1_1987 = . if age1_1987 == 99
replace age2_1987 = . if age2_1987 == 99
replace num_dep3_1987 = 0 if num_dep3_1987 == 9
replace mstat2_1987 = . if mstat2_1987 == 9
replace mstat1_1987 = . if mstat1_1987 == 9
replace state1_1987 = . if state1_1987 == 99
...
replace state = 1 if state1_1987 == 1   // AL
replace state = 2 if state1_1987 == 50   // AK
replace state = 3 if state1_1987 == 2   // AZ
replace state = 4 if state1_1987 == 3   // AR
replace state = 5 if state1_1987 == 4   // CA
replace state = 6 if state1_1987 == 5   // CO
replace state = 7 if state1_1987 == 6   // CT
replace state = 8 if state1_1987 == 7   // DE
replace state = 9 if state1_1987 == 8   // DC
replace state = 10 if state1_1987 == 9   // FL
replace state = 11 if state1_1987 == 10   // GA
replace state = 12 if state1_1987 == 51   // HI
replace state = 13 if state1_1987 == 11   // ID
replace state = 14 if state1_1987 == 12   // IL
replace state = 15 if state1_1987 == 13   // IN
replace state = 16 if state1_1987 == 14   // IA
replace state = 17 if state1_1987 == 15   // KS
replace state = 18 if state1_1987 == 16   // KY
replace state = 19 if state1_1987 == 17   // LA
replace state = 20 if state1_1987 == 18   // ME
replace state = 21 if state1_1987 == 19   // MD
replace state = 22 if state1_1987 == 20   // MA
replace state = 23 if state1_1987 == 21   // MI
replace state = 24 if state1_1987 == 22   // MN
replace state = 25 if state1_1987 == 23   // MS
replace state = 26 if state1_1987 == 24   // MO
replace state = 27 if state1_1987 == 25   // MT
replace state = 28 if state1_1987 == 26   // NE
replace state = 29 if state1_1987 == 27   // NV
replace state = 30 if state1_1987 == 28   // NH
replace state = 31 if state1_1987 == 29   // NJ
replace state = 32 if state1_1987 == 30   // NM
replace state = 33 if state1_1987 == 31   // NY
replace state = 34 if state1_1987 == 32   // NC
replace state = 35 if state1_1987 == 33   // ND
replace state = 36 if state1_1987 == 34   // OH
replace state = 37 if state1_1987 == 35   // OK
replace state = 38 if state1_1987 == 36   // OR
replace state = 39 if state1_1987 == 37   // PA
replace state = 40 if state1_1987 == 38   // RI
replace state = 41 if state1_1987 == 39   // SC
replace state = 42 if state1_1987 == 40   // SD
replace state = 43 if state1_1987 == 41   // TN
replace state = 44 if state1_1987 == 42   // TX
replace state = 45 if state1_1987 == 43   // UT
replace state = 46 if state1_1987 == 44   // VT
replace state = 47 if state1_1987 == 45   // VA
replace state = 48 if state1_1987 == 46   // WA
replace state = 49 if state1_1987 == 47   // WV
replace state = 50 if state1_1987 == 48   // WI
replace state = 51 if state1_1987 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1987 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1987 > 65 & age1_1987 ~= .
replace agex = agex + 1 if age2_1987 > 65 & age2_1987 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1987
...
gen swages = wages2_1987
* Business labor income not added

*** Set Pension Income
* Pension income for 1968-1969 surveys not calculated because only bracketed data available
gen pensions = 0
replace pensions = pension_inc2_1987
replace pensions = pensions + pension_inc3_1987
* Calculate spouse's pension income (1985 + )
gen spouse_pensions = 0
replace spouse_pensions = spouse_pensions + pension_inc4_1987
replace spouse_pensions = spouse_pensions + pension_inc5_1987
...
gen otherprop = 0
replace otherprop = tax_inc1_1987 - pensions - pwages - swages if tax_inc1_1987 > pensions + pwages + swages
...
gen gssi = 0
replace gssi = gssi2_1987
replace gssi = gssi + gssi3_1987
...
gen ui = 0
replace ui = unemp_inc2_1987
replace ui = ui + unemp_inc3_1987

*** Set Government Transfer Income
* Measured (when available) as total transfer income less unemployment income
gen transfers = 0
replace transfers = transfers1_1987 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1987

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1987
