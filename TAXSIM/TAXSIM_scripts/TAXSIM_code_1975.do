...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1975
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1975
...
*** Rename 1975 Variables
rename V3921 age1_1975, replace
rename V3923 age2_1975, replace
rename V3802 family_ID1_1975, replace
rename V3872 tax_inc1_1975, replace
rename V3880 gssi1_1975, replace
rename V4053 mstat2_1975, replace
rename V3875 num_dep1_1975, replace
rename V3924 num_dep2_1975, replace
rename V4079 num_dep3_1975, replace
rename V3881 pension_inc1_1975, replace
rename V4152 prop_tax1_1975, replace
rename V3819 rent1_1975, replace
rename V3803 state1_1975, replace
rename V3889 transfers1_1975, replace
rename V3882 unemp_inc1_1975, replace
rename V3863 wages1_1975, replace
rename V3865 wages2_1975, replace

*** Clean 1975 Variables
replace age1_1975 = . if age1_1975 == 99
replace age2_1975 = . if age2_1975 == 99
replace num_dep3_1975 = 0 if num_dep3_1975 == 9
replace state1_1975 = . if state1_1975 == 99
...
replace state = 1 if state1_1975 == 1   // AL
replace state = 2 if state1_1975 == 50   // AK
replace state = 3 if state1_1975 == 2   // AZ
replace state = 4 if state1_1975 == 3   // AR
replace state = 5 if state1_1975 == 4   // CA
replace state = 6 if state1_1975 == 5   // CO
replace state = 7 if state1_1975 == 6   // CT
replace state = 8 if state1_1975 == 7   // DE
replace state = 9 if state1_1975 == 8   // DC
replace state = 10 if state1_1975 == 9   // FL
replace state = 11 if state1_1975 == 10   // GA
replace state = 12 if state1_1975 == 51   // HI
replace state = 13 if state1_1975 == 11   // ID
replace state = 14 if state1_1975 == 12   // IL
replace state = 15 if state1_1975 == 13   // IN
replace state = 16 if state1_1975 == 14   // IA
replace state = 17 if state1_1975 == 15   // KS
replace state = 18 if state1_1975 == 16   // KY
replace state = 19 if state1_1975 == 17   // LA
replace state = 20 if state1_1975 == 18   // ME
replace state = 21 if state1_1975 == 19   // MD
replace state = 22 if state1_1975 == 20   // MA
replace state = 23 if state1_1975 == 21   // MI
replace state = 24 if state1_1975 == 22   // MN
replace state = 25 if state1_1975 == 23   // MS
replace state = 26 if state1_1975 == 24   // MO
replace state = 27 if state1_1975 == 25   // MT
replace state = 28 if state1_1975 == 26   // NE
replace state = 29 if state1_1975 == 27   // NV
replace state = 30 if state1_1975 == 28   // NH
replace state = 31 if state1_1975 == 29   // NJ
replace state = 32 if state1_1975 == 30   // NM
replace state = 33 if state1_1975 == 31   // NY
replace state = 34 if state1_1975 == 32   // NC
replace state = 35 if state1_1975 == 33   // ND
replace state = 36 if state1_1975 == 34   // OH
replace state = 37 if state1_1975 == 35   // OK
replace state = 38 if state1_1975 == 36   // OR
replace state = 39 if state1_1975 == 37   // PA
replace state = 40 if state1_1975 == 38   // RI
replace state = 41 if state1_1975 == 39   // SC
replace state = 42 if state1_1975 == 40   // SD
replace state = 43 if state1_1975 == 41   // TN
replace state = 44 if state1_1975 == 42   // TX
replace state = 45 if state1_1975 == 43   // UT
replace state = 46 if state1_1975 == 44   // VT
replace state = 47 if state1_1975 == 45   // VA
replace state = 48 if state1_1975 == 46   // WA
replace state = 49 if state1_1975 == 47   // WV
replace state = 50 if state1_1975 == 48   // WI
replace state = 51 if state1_1975 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1975 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1975 > 65 & age1_1975 ~= .
replace agex = agex + 1 if age2_1975 > 65 & age2_1975 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1975
...
gen otherprop = 0
replace otherprop = tax_inc1_1975 - pensions - pwages - swages if tax_inc1_1975 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1975 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1975

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1975
