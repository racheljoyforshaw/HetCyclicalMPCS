...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1971
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1971
...
*** Rename 1971 Variables
rename V1942 age1_1971, replace
rename V1944 age2_1971, replace
rename V1865 childcare1_1971, replace
rename V1802 family_ID1_1971, replace
rename V1906 tax_inc1_1971, replace
rename V1914 gssi1_1971, replace
rename V2072 mstat2_1971, replace
rename V1909 num_dep1_1971, replace
rename V1945 num_dep2_1971, replace
rename V2113 num_dep3_1971, replace
rename V1915 pension_inc1_1971, replace
rename V2221 prop_tax1_1971, replace
rename V1829 rent1_1971, replace
rename V1803 state1_1971, replace
rename V1922 transfers1_1971, replace
rename V1916 unemp_inc1_1971, replace
rename V1897 wages1_1971, replace
rename V1899 wages2_1971, replace

*** Clean 1971 Variables
replace age1_1971 = . if age1_1971 == 99
replace age2_1971 = . if age2_1971 == 99
replace num_dep3_1971 = 0 if num_dep3_1971 == 9
replace state1_1971 = . if state1_1971 == 99
...
replace state = 1 if state1_1971 == 1   // AL
replace state = 2 if state1_1971 == 50   // AK
replace state = 3 if state1_1971 == 2   // AZ
replace state = 4 if state1_1971 == 3   // AR
replace state = 5 if state1_1971 == 4   // CA
replace state = 6 if state1_1971 == 5   // CO
replace state = 7 if state1_1971 == 6   // CT
replace state = 8 if state1_1971 == 7   // DE
replace state = 9 if state1_1971 == 8   // DC
replace state = 10 if state1_1971 == 9   // FL
replace state = 11 if state1_1971 == 10   // GA
replace state = 12 if state1_1971 == 51   // HI
replace state = 13 if state1_1971 == 11   // ID
replace state = 14 if state1_1971 == 12   // IL
replace state = 15 if state1_1971 == 13   // IN
replace state = 16 if state1_1971 == 14   // IA
replace state = 17 if state1_1971 == 15   // KS
replace state = 18 if state1_1971 == 16   // KY
replace state = 19 if state1_1971 == 17   // LA
replace state = 20 if state1_1971 == 18   // ME
replace state = 21 if state1_1971 == 19   // MD
replace state = 22 if state1_1971 == 20   // MA
replace state = 23 if state1_1971 == 21   // MI
replace state = 24 if state1_1971 == 22   // MN
replace state = 25 if state1_1971 == 23   // MS
replace state = 26 if state1_1971 == 24   // MO
replace state = 27 if state1_1971 == 25   // MT
replace state = 28 if state1_1971 == 26   // NE
replace state = 29 if state1_1971 == 27   // NV
replace state = 30 if state1_1971 == 28   // NH
replace state = 31 if state1_1971 == 29   // NJ
replace state = 32 if state1_1971 == 30   // NM
replace state = 33 if state1_1971 == 31   // NY
replace state = 34 if state1_1971 == 32   // NC
replace state = 35 if state1_1971 == 33   // ND
replace state = 36 if state1_1971 == 34   // OH
replace state = 37 if state1_1971 == 35   // OK
replace state = 38 if state1_1971 == 36   // OR
replace state = 39 if state1_1971 == 37   // PA
replace state = 40 if state1_1971 == 38   // RI
replace state = 41 if state1_1971 == 39   // SC
replace state = 42 if state1_1971 == 40   // SD
replace state = 43 if state1_1971 == 41   // TN
replace state = 44 if state1_1971 == 42   // TX
replace state = 45 if state1_1971 == 43   // UT
replace state = 46 if state1_1971 == 44   // VT
replace state = 47 if state1_1971 == 45   // VA
replace state = 48 if state1_1971 == 46   // WA
replace state = 49 if state1_1971 == 47   // WV
replace state = 50 if state1_1971 == 48   // WI
replace state = 51 if state1_1971 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1971 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1971 > 65 & age1_1971 ~= .
replace agex = agex + 1 if age2_1971 > 65 & age2_1971 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1971
...
gen otherprop = 0
replace otherprop = tax_inc1_1971 - pensions - pwages - swages if tax_inc1_1971 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1971 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1971

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1971
...
gen childcare = 0
replace childcare = childcare1_1971
