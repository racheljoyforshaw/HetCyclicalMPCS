...
****************************************************************************************************
* Annual TAXSIM Calculator for PSID Data: 1977
* Authors: Margaret McKeehan and Nick Frazier
* 
* Uses Family Public Data for 1977
...
*** Rename 1977 Variables
rename V5350 age1_1977, replace
rename V5352 age2_1977, replace
rename V5259 childcare1_1977, replace
rename V5202 family_ID1_1977, replace
rename V5297 tax_inc1_1977, replace
rename V5306 gssi1_1977, replace
rename V5502 mstat1_1977, replace
rename V5650 mstat2_1977, replace
rename V5300 num_dep1_1977, replace
rename V5353 num_dep2_1977, replace
rename V5558 num_dep3_1977, replace
rename V5307 pension_inc1_1977, replace
rename V5224 prop_tax1_1977, replace
rename V5225 rent1_1977, replace
rename V5203 state1_1977, replace
rename V5316 transfers1_1977, replace
rename V5308 unemp_inc2_1977, replace
rename V5627 wages1_1977, replace
rename V5289 wages2_1977, replace

*** Clean 1977 Variables
replace age1_1977 = . if age1_1977 == 99
replace age2_1977 = . if age2_1977 == 99
replace num_dep3_1977 = 0 if num_dep3_1977 == 9
replace state1_1977 = . if state1_1977 == 99
replace prop_tax1_1977 = . if prop_tax1_1977 == 9999
...
replace state = 1 if state1_1977 == 1   // AL
replace state = 2 if state1_1977 == 50   // AK
replace state = 3 if state1_1977 == 2   // AZ
replace state = 4 if state1_1977 == 3   // AR
replace state = 5 if state1_1977 == 4   // CA
replace state = 6 if state1_1977 == 5   // CO
replace state = 7 if state1_1977 == 6   // CT
replace state = 8 if state1_1977 == 7   // DE
replace state = 9 if state1_1977 == 8   // DC
replace state = 10 if state1_1977 == 9   // FL
replace state = 11 if state1_1977 == 10   // GA
replace state = 12 if state1_1977 == 51   // HI
replace state = 13 if state1_1977 == 11   // ID
replace state = 14 if state1_1977 == 12   // IL
replace state = 15 if state1_1977 == 13   // IN
replace state = 16 if state1_1977 == 14   // IA
replace state = 17 if state1_1977 == 15   // KS
replace state = 18 if state1_1977 == 16   // KY
replace state = 19 if state1_1977 == 17   // LA
replace state = 20 if state1_1977 == 18   // ME
replace state = 21 if state1_1977 == 19   // MD
replace state = 22 if state1_1977 == 20   // MA
replace state = 23 if state1_1977 == 21   // MI
replace state = 24 if state1_1977 == 22   // MN
replace state = 25 if state1_1977 == 23   // MS
replace state = 26 if state1_1977 == 24   // MO
replace state = 27 if state1_1977 == 25   // MT
replace state = 28 if state1_1977 == 26   // NE
replace state = 29 if state1_1977 == 27   // NV
replace state = 30 if state1_1977 == 28   // NH
replace state = 31 if state1_1977 == 29   // NJ
replace state = 32 if state1_1977 == 30   // NM
replace state = 33 if state1_1977 == 31   // NY
replace state = 34 if state1_1977 == 32   // NC
replace state = 35 if state1_1977 == 33   // ND
replace state = 36 if state1_1977 == 34   // OH
replace state = 37 if state1_1977 == 35   // OK
replace state = 38 if state1_1977 == 36   // OR
replace state = 39 if state1_1977 == 37   // PA
replace state = 40 if state1_1977 == 38   // RI
replace state = 41 if state1_1977 == 39   // SC
replace state = 42 if state1_1977 == 40   // SD
replace state = 43 if state1_1977 == 41   // TN
replace state = 44 if state1_1977 == 42   // TX
replace state = 45 if state1_1977 == 43   // UT
replace state = 46 if state1_1977 == 44   // VT
replace state = 47 if state1_1977 == 45   // VA
replace state = 48 if state1_1977 == 46   // WA
replace state = 49 if state1_1977 == 47   // WV
replace state = 50 if state1_1977 == 48   // WI
replace state = 51 if state1_1977 == 49   // WY
...
gen depx = 0
replace depx = num_dep1_1977 - mstat
...
gen agex = 0
replace agex = agex + 1 if age1_1977 > 65 & age1_1977 ~= .
replace agex = agex + 1 if age2_1977 > 65 & age2_1977 ~= .

*** Set the Head's Wage and Salary Income
gen pwages = wages1_1977
...
gen otherprop = 0
replace otherprop = tax_inc1_1977 - pensions - pwages - swages if tax_inc1_1977 > pensions + pwages + swages
...
gen transfers = 0
replace transfers = transfers1_1977 - ui

*** Set Rent Paid
gen rentpaid = 0
replace rentpaid = rent1_1977

*** Set Estimated Property Tax Payments
gen proptax = 0
replace proptax = prop_tax1_1977
...
gen childcare = 0
replace childcare = childcare1_1977
