...
library("ivpack")
# MPC
print("MPC balanced 07")
for (i in c(1,2,3,4,5)){
	mdl <- ivreg(dct ~ dyt, ~ dytplus1, x=TRUE, data=covData_030507, subset=quintile==i)
...
# MPC
print("MPC balanced 13")
for (i in c(1,2,3,4,5)){
	mdl = ivreg(dct ~ dyt, ~ dytplus1, x=TRUE, data=covData_091113, subset=quintile==i)
