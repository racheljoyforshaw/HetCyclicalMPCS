...
consumption_030507.lm = rq(logConsumption ~ year +
                             yob +
                             educ +
                             white +
                             black +
                             ...
                             region*year
                           , regressionData_030507, tau = seq(0, 1, by = 0.2)) 
regressionData_030507 <- regressionData_030507 %>% add_residuals(consumption_030507.lm)	
names(regressionData_030507)[names(regressionData_030507)=="resid"] <-"resConsumption"


consumption_091113.lm = rq(logConsumption ~ year +
                             yob +
                             educ +
                             white +
                             black +
                             ...
                             region*year,
                           regressionData_091113, tau = seq(0, 1, by = 0.2)) 
regressionData_091113 <- regressionData_091113 %>% add_residuals(consumption_091113.lm)	
names(regressionData_091113)[names(regressionData_091113)=="resid"] <-"resConsumption"
...
#          cov((covData_030507$resConsumption.2005[,i] - covData_030507$resConsumption.2003[,i]),(covData_030507$resIncome.2007[,i] - covData_030507$resIncome.2005[,i]))/cov((covData_030507$resIncome.2005[,i] - covData_030507$resIncome.2003[,i]),(covData_030507$resIncome.2007[,i] - covData_030507$resIncome.2005[,i]))
#   )
...
#          cov((covData_091113$resConsumption.2011[,i] - covData_091113$resConsumption.2009[,i]),(covData_091113$resIncome.2013[,i] - covData_091113$resIncome.2011[,i]))/cov((covData_091113$resIncome.2011[,i] - covData_091113$resIncome.2009[,i]),(covData_091113$resIncome.2013[,i] - covData_091113$resIncome.2011[,i]))
#   )
