...
for (i in c(1,2,3,4,5)){
  betahat <- cov(subset(covData_030507$dct,covData_030507$quintile==i),subset(covData_030507$dytplus1,covData_030507$quintile==i))/
    cov(subset(covData_030507$dytplus1,covData_030507$quintile==i),subset(covData_030507$dyt,covData_030507$quintile==i))
  dcthat <- betahat*subset(covData_030507$dytplus1,covData_030507$quintile==i)
  resid <- subset(covData_030507$dct,covData_030507$quintile==i) - dcthat
  se <- sqrt(sum(resid^2)/length(subset(covData_030507$dct,covData_030507$quintile==i)))
...
print("MPC 13")
for (i in c(1,2,3,4,5)){
  betahat <- cov(subset(covData_091113$dct,covData_091113$quintile==i),subset(covData_091113$dytplus1,covData_091113$quintile==i))/
    cov(subset(covData_091113$dytplus1,covData_091113$quintile==i),subset(covData_091113$dyt,covData_091113$quintile==i))
  dcthat <- betahat*subset(covData_091113$dytplus1,covData_091113$quintile==i)
  resid <- subset(covData_091113$dct,covData_091113$quintile==i) - dcthat
  se <- sqrt(sum(resid^2)/length(subset(covData_091113$dct,covData_091113$quintile==i)))
...
ggplot(data = out_MPC_KV, aes(x = quantile, y = MPC, group=year, color=year)) +
  ...
  geom_ribbon(data= out_MPC_KV,aes(ymin= MPC_CI_lower,ymax= MPC_CI_upper),alpha=0.3) +
